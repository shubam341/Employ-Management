...
const Login=()=>{
   ...
   <div className='flex h-screen w-screen items-center justify-center'>
    <div className='border-3 border-red-600 p-200'>
        <form  className='flex flex-col items-center justify-center'>
            ...
            <input className='text-black outline-none bg-transparent border-2  border-emerald-600 text-xl py-4 px-5  rounded-full mt-5 placeholder:text-white' type="password" placeholder ='Enter password' />
